...
| <a name="input_destination_role_name_billing"></a> [destination\_role\_name\_billing](#input\_destination\_role\_name\_billing) | Role name for billing access in destination AWS account | `string` | `null` | no |
...
| <a name="output_billing_role_arn"></a> [billing\_role\_arn](#output\_billing\_role\_arn) | n/a |
| <a name="output_billing_role_name"></a> [billing\_role\_name](#output\_billing\_role\_name) | n/a |
